...
GitHub makes this easy.  You can even just add the raw .txt file to a repo by copy / pasting in a new file through the browser if you'd like. e.g. https://raw.githubusercontent.com/Pierce-Evan/JokeyJokes/main/CleanedUpAllArticles.txt
